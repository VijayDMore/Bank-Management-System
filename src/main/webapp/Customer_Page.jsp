<%@page import="com.jsp.service.CustomerServices"%>
...
<body>
	...
	<form>
		<input type="button" name="update_customer" value="UPDATE"
			onclick="showForm('UpdateCustomer')">
	</form>
	...
	<div class="form-container" id="UpdateCustomer">
		...
		<form action="UpdateCustomer" method="post" id="updateForCustomer">
			...
			<label for="customer_Id">Customer ID :</label> <input type="number"
				name="customer_Id" value="<%=request.getParameter("customerId")%>"><br>
				
			<br> <label for="customeremail">Email: </label> <input
				type="email" name="customeremail"><br>
				
			<br> <label for="customerpassword">Password: </label> <input
				type="password" name="customerpassword"><br>
